...
namespace FlutterSharp.Utilities
{
    ...
    internal class NativeMethods
    {
        ...
        [DllImport(USER32)]
        public static extern bool GetUpdateRect(IntPtr handle, out RECT rect, bool erase);

        [DllImport(USER32)]
        public static extern bool IntersectRect(out RECT lprcDest, ref RECT src1, ref RECT src2);

        [DllImport(USER32)]
        public static extern IntPtr SendMessage(IntPtr hWnd, Messages.WM msg, IntPtr wParam, IntPtr lParam);

        [DllImport(USER32)]
        public static extern IntPtr PostMessage(IntPtr hWnd, Messages.WM msg, IntPtr wParam, IntPtr lParam);
        ...
        [DllImport(VERSION, SetLastError = true, CharSet = CharSet.Unicode)]
        ...
        [DllImport(USER32)]
        public static extern int RedrawWindow(IntPtr hWnd, [In] ref RECT lprcUpdate, IntPtr hrgnUpdate, uint flags);
        ...
        [DllImport(KERNEL32, SetLastError = true, CallingConvention = CallingConvention.Winapi, CharSet = CharSet.Auto)]
